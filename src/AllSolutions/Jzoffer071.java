...
public class Jzoffer071 {
    ...
    private TreeNode buildSubTree(int[] preorder,int[] inorder,final int rootIndexInpreorder,final int firstIndexIninorder,final int lastIndexIninorder) {
        ...
        if (rootIndexIninorder > firstIndexIninorder) {
            root.left = buildSubTree(preorder,inorder,rootIndexInpreorder + 1,firstIndexIninorder,rootIndexIninorder - 1);
        }
